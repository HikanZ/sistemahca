							...
							<form action="#">
								<div class="container">
									<div class="accordion" id="accordion" name="accordion">
									  <div class="card">
									    <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" href="#top">
									      <h5 class="mb-0">
									  ...
									  <div class="card">
									    <div class="card-header" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" href="#top">
									      <h5 class="mb-0">
									        <button class="btnA collapsed" type="button">
									  ...
									  <div class="card">
									    <div class="card-header" id="headingThree"  data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" href="#top">
									      <h5 class="mb-0">
									        <button class="btnA collapsed" type="button">
